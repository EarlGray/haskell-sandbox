...
swapMap :: Char -> Char -> DecipherMap -> DecipherMap
swapMap c1 c2 dm = M.insert c1 cd2 . M.insert c2 cd1 $ dm
  where
    cd1 = fromJust $ M.lookup c1 dm
    cd2 = fromJust $ M.lookup c2 dm
...
generateMaps :: (Int, Int) -> String -> String -> [DecipherMap]
...
-- characters of the input sorted by frequency
freqstring :: String -> String
...
-- <sample freq str> <decipher map> -> <CT freq map of the map>
freqstrByMap :: String -> DecipherMap -> String
...
bestGuesses :: (Int, Int) -> String -> String -> SampleDict -> String -> [(Int, String)]
...
chooseNextCtFrqStr :: [(Int, String)] -> Int -> (Int, String)
...
solveSteps :: String -> String -> SampleDict -> String -> [(Int, Int, String)]
